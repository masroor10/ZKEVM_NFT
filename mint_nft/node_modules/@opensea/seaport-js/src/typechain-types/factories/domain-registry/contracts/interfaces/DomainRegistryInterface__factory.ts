...
} from "../../../../domain-registry/contracts/interfaces/DomainRegistryInterface";
...
export class DomainRegistryInterface__factory {
  ...
  static createInterface(): DomainRegistryInterfaceInterface {
    return new utils.Interface(_abi) as DomainRegistryInterfaceInterface;
  }
  static connect(
    address: string,
