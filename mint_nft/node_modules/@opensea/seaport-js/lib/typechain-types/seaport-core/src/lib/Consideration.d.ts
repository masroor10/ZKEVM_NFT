...
export interface ConsiderationInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "getContractOffererNonce", values: [string]): string;
...
export interface Consideration extends BaseContract {
    ...
    functions: {
        ...
        fulfillAdvancedOrder(arg0: AdvancedOrderStruct, arg1: CriteriaResolverStruct[], fulfillerConduitKey: BytesLike, recipient: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        fulfillAvailableAdvancedOrders(arg0: AdvancedOrderStruct[], arg1: CriteriaResolverStruct[], arg2: FulfillmentComponentStruct[][], arg3: FulfillmentComponentStruct[][], fulfillerConduitKey: BytesLike, recipient: string, maximumFulfilled: BigNumberish, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        fulfillAvailableOrders(arg0: OrderStruct[], arg1: FulfillmentComponentStruct[][], arg2: FulfillmentComponentStruct[][], fulfillerConduitKey: BytesLike, maximumFulfilled: BigNumberish, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        fulfillOrder(arg0: OrderStruct, fulfillerConduitKey: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        getContractOffererNonce(contractOfferer: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            nonce: BigNumber;
        }>;
        ...
        matchAdvancedOrders(arg0: AdvancedOrderStruct[], arg1: CriteriaResolverStruct[], arg2: FulfillmentStruct[], recipient: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        fulfillAdvancedOrder(arg0: AdvancedOrderStruct, arg1: CriteriaResolverStruct[], fulfillerConduitKey: BytesLike, recipient: string, overrides?: CallOverrides): Promise<boolean>;
        fulfillAvailableAdvancedOrders(arg0: AdvancedOrderStruct[], arg1: CriteriaResolverStruct[], arg2: FulfillmentComponentStruct[][], arg3: FulfillmentComponentStruct[][], fulfillerConduitKey: BytesLike, recipient: string, maximumFulfilled: BigNumberish, overrides?: CallOverrides): Promise<[boolean[], ExecutionStructOutput[]]>;
        fulfillAvailableOrders(arg0: OrderStruct[], arg1: FulfillmentComponentStruct[][], arg2: FulfillmentComponentStruct[][], fulfillerConduitKey: BytesLike, maximumFulfilled: BigNumberish, overrides?: CallOverrides): Promise<[boolean[], ExecutionStructOutput[]]>;
        ...
        fulfillOrder(arg0: OrderStruct, fulfillerConduitKey: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        getContractOffererNonce(contractOfferer: string, overrides?: CallOverrides): Promise<BigNumber>;
        getCounter(offerer: string, overrides?: CallOverrides): Promise<BigNumber>;
        getOrderHash(arg0: OrderComponentsStruct, overrides?: CallOverrides): Promise<string>;
        getOrderStatus(orderHash: BytesLike, overrides?: CallOverrides): Promise<[
        ...
        matchAdvancedOrders(arg0: AdvancedOrderStruct[], arg1: CriteriaResolverStruct[], arg2: FulfillmentStruct[], recipient: string, overrides?: CallOverrides): Promise<ExecutionStructOutput[]>;
    ...
    populateTransaction: {
        ...
        getContractOffererNonce(contractOfferer: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
