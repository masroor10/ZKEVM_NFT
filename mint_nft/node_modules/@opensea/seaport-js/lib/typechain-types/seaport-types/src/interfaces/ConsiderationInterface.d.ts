...
export interface ConsiderationInterface extends BaseContract {
    ...
    functions: {
        ...
        matchAdvancedOrders(orders: AdvancedOrderStruct[], criteriaResolvers: CriteriaResolverStruct[], fulfillments: FulfillmentStruct[], recipient: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        matchAdvancedOrders(orders: AdvancedOrderStruct[], criteriaResolvers: CriteriaResolverStruct[], fulfillments: FulfillmentStruct[], recipient: string, overrides?: CallOverrides): Promise<ExecutionStructOutput[]>;
