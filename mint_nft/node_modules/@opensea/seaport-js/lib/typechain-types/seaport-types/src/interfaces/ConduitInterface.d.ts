...
export interface ConduitInterface extends BaseContract {
    ...
    functions: {
        ...
        executeBatch1155(batch1155Transfers: ConduitBatch1155TransferStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        executeWithBatch1155(standardTransfers: ConduitTransferStruct[], batch1155Transfers: ConduitBatch1155TransferStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        executeBatch1155(batch1155Transfers: ConduitBatch1155TransferStruct[], overrides?: CallOverrides): Promise<string>;
        executeWithBatch1155(standardTransfers: ConduitTransferStruct[], batch1155Transfers: ConduitBatch1155TransferStruct[], overrides?: CallOverrides): Promise<string>;
