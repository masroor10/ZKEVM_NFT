...
export interface DomainRegistryInterfaceInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "getDomain" | "getDomains" | "getNumberOfDomains" | "setDomain"): FunctionFragment;
