...
export interface LocalConduitInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "execute" | "executeBatch1155" | "executeWithBatch1155" | "updateChannel"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "updateChannel", values: [string, boolean]): string;
...
export interface LocalConduit extends BaseContract {
    ...
    functions: {
        execute(transfers: ConduitTransferStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        executeBatch1155(batchTransfers: ConduitBatch1155TransferStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        executeWithBatch1155(standardTransfers: ConduitTransferStruct[], batchTransfers: ConduitBatch1155TransferStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        updateChannel(channel: string, isOpen: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    execute(transfers: ConduitTransferStruct[], overrides?: Overrides & {
    ...
    callStatic: {
        execute(transfers: ConduitTransferStruct[], overrides?: CallOverrides): Promise<string>;
        executeBatch1155(batchTransfers: ConduitBatch1155TransferStruct[], overrides?: CallOverrides): Promise<string>;
        executeWithBatch1155(standardTransfers: ConduitTransferStruct[], batchTransfers: ConduitBatch1155TransferStruct[], overrides?: CallOverrides): Promise<string>;
        updateChannel(channel: string, isOpen: boolean, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        "ChannelUpdated(address,bool)"(channel?: string | null, open?: null): ChannelUpdatedEventFilter;
        ChannelUpdated(channel?: string | null, open?: null): ChannelUpdatedEventFilter;
    };
    estimateGas: {
        execute(transfers: ConduitTransferStruct[], overrides?: Overrides & {
            from?: string;
