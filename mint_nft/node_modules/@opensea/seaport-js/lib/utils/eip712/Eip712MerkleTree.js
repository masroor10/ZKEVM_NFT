...
const getTree = (leaves, defaultLeafHash) => new merkletreejs_1.MerkleTree(leaves.map(utils_2.hexToBuffer), utils_2.bufferKeccak, {
    complete: true,
    sort: false,
    hashLeaves: false,
...
const encodeProof = (key, proof, signature = `0x${"ff".repeat(64)}`) => {
    return (0, utils_1.hexConcat)([
        ...
        utils_1.defaultAbiCoder.encode([`uint256[${proof.length}]`], [proof]),
    ]);
};
class Eip712MerkleTree {
    ...
    getCompleteElements() {
        ...
        return (0, utils_2.fillArray)([...elements], this.completedSize, this.defaultNode);
    }
    ...
    getCompleteLeaves() {
        ...
        return (0, utils_2.fillArray)([...leaves], this.completedSize, this.defaultLeaf);
    }
    get root() {
    ...
    getBulkOrderHash() {
        ...
        const leaves = this.getCompleteLeaves().map(utils_2.hexToBuffer);
        const rootHash = (0, utils_2.bufferToHex)((0, utils_2.getRoot)(leaves, false));
        const typeHash = (0, utils_1.keccak256)((0, utils_1.toUtf8Bytes)(this.encoder._types.BulkOrder));
        const bulkOrderHash = (0, utils_1.keccak256)((0, utils_1.hexConcat)([typeHash, rootHash]));
    ...
    constructor(types, rootType, leafType, elements, depth) {
        ...
        this.depth = depth;
        const encoder = hash_1._TypedDataEncoder.from(types);
