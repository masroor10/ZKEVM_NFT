...
exports.chunk = chunk;
const bufferToHex = (buf) => (0, utils_1.hexlify)(buf);
exports.bufferToHex = bufferToHex;
const hexToBuffer = (value) => Buffer.from(value.slice(2), "hex");
exports.hexToBuffer = hexToBuffer;
const bufferKeccak = (value) => (0, exports.hexToBuffer)((0, utils_1.keccak256)(value));
exports.bufferKeccak = bufferKeccak;
const hashConcat = (arr) => (0, exports.bufferKeccak)((0, utils_1.hexConcat)(arr));
