...
export declare namespace ERC721Hybrid {
    ...
    type IDMintStructOutput = [string, BigNumber[]] & {
        to: string;
        tokenIds: BigNumber[];
    };
    type MintStruct = {
    ...
    type MintStructOutput = [string, BigNumber] & {
        to: string;
        quantity: BigNumber;
    };
    type IDBurnStruct = {
    ...
    type IDBurnStructOutput = [string, BigNumber[]] & {
        owner: string;
        tokenIds: BigNumber[];
    };
    ...
    type TransferRequestStructOutput = [string, string[], BigNumber[]] & {
        from: string;
        tos: string[];
        tokenIds: BigNumber[];
    };
...
export interface ImmutableERC721Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DEFAULT_ADMIN_ROLE" | "DOMAIN_SEPARATOR" | "MINTER_ROLE" | "approve" | "balanceOf" | "baseURI" | "burn" | "burnBatch" | "contractURI" | "eip712Domain" | "exists" | "getAdmins" | "getApproved" | "getRoleAdmin" | "getRoleMember" | "getRoleMemberCount" | "grantMinterRole" | "grantRole" | "hasRole" | "isApprovedForAll" | "mint" | "mintBatch" | "mintBatchByQuantity" | "mintBatchByQuantityThreshold" | "mintByQuantity" | "name" | "nonces" | "operatorAllowlist" | "ownerOf" | "permit" | "renounceRole" | "revokeMinterRole" | "revokeRole" | "royaltyInfo" | "safeBurn" | "safeBurnBatch" | "safeMint" | "safeMintBatch" | "safeMintBatchByQuantity" | "safeMintByQuantity" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "safeTransferFromBatch" | "setApprovalForAll" | "setBaseURI" | "setContractURI" | "setDefaultRoyaltyReceiver" | "setNFTRoyaltyReceiver" | "setNFTRoyaltyReceiverBatch" | "setOperatorAllowlistRegistry" | "supportsInterface" | "symbol" | "tokenURI" | "totalSupply" | "transferFrom"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "mintBatch", values: [ERC721Hybrid.IDMintStruct[]]): string;
    encodeFunctionData(functionFragment: "mintBatchByQuantity", values: [ERC721Hybrid.MintStruct[]]): string;
    encodeFunctionData(functionFragment: "mintBatchByQuantityThreshold", values?: undefined): string;
    encodeFunctionData(functionFragment: "mintByQuantity", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: "safeBurn", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "safeBurnBatch", values: [ERC721Hybrid.IDBurnStruct[]]): string;
    encodeFunctionData(functionFragment: "safeMint", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "safeMintBatch", values: [ERC721Hybrid.IDMintStruct[]]): string;
    encodeFunctionData(functionFragment: "safeMintBatchByQuantity", values: [ERC721Hybrid.MintStruct[]]): string;
    encodeFunctionData(functionFragment: "safeMintByQuantity", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: "safeTransferFromBatch", values: [ERC721Hybrid.TransferRequestStruct]): string;
    ...
    decodeFunctionResult(functionFragment: "mintBatchByQuantity", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "mintBatchByQuantityThreshold", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "mintByQuantity", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "safeMintBatchByQuantity", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "safeMintByQuantity", data: BytesLike): Result;
...
export interface ImmutableERC721 extends BaseContract {
    ...
    functions: {
        ...
        mintBatch(mints: ERC721Hybrid.IDMintStruct[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        mintBatchByQuantity(mints: ERC721Hybrid.MintStruct[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        mintBatchByQuantityThreshold(overrides?: CallOverrides): Promise<[BigNumber]>;
        mintByQuantity(to: PromiseOrValue<string>, quantity: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        permit(spender: PromiseOrValue<string>, tokenId: PromiseOrValue<BigNumberish>, deadline: PromiseOrValue<BigNumberish>, sig: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        safeBurn(owner: PromiseOrValue<string>, tokenId: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        safeBurnBatch(burns: ERC721Hybrid.IDBurnStruct[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        safeMint(to: PromiseOrValue<string>, tokenId: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        safeMintBatch(mints: ERC721Hybrid.IDMintStruct[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        safeMintBatchByQuantity(mints: ERC721Hybrid.MintStruct[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        safeMintByQuantity(to: PromiseOrValue<string>, quantity: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        safeTransferFromBatch(tr: ERC721Hybrid.TransferRequestStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        setContractURI(_contractURI: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        mintBatch(mints: ERC721Hybrid.IDMintStruct[], overrides?: CallOverrides): Promise<void>;
        mintBatchByQuantity(mints: ERC721Hybrid.MintStruct[], overrides?: CallOverrides): Promise<void>;
        mintBatchByQuantityThreshold(overrides?: CallOverrides): Promise<BigNumber>;
        mintByQuantity(to: PromiseOrValue<string>, quantity: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        name(overrides?: CallOverrides): Promise<string>;
        nonces(tokenId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        operatorAllowlist(overrides?: CallOverrides): Promise<string>;
        ownerOf(tokenId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
        permit(spender: PromiseOrValue<string>, tokenId: PromiseOrValue<BigNumberish>, deadline: PromiseOrValue<BigNumberish>, sig: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        ...
        royaltyInfo(tokenId: PromiseOrValue<BigNumberish>, salePrice: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string, BigNumber]>;
        safeBurn(owner: PromiseOrValue<string>, tokenId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        safeBurnBatch(burns: ERC721Hybrid.IDBurnStruct[], overrides?: CallOverrides): Promise<void>;
        safeMint(to: PromiseOrValue<string>, tokenId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        safeMintBatch(mints: ERC721Hybrid.IDMintStruct[], overrides?: CallOverrides): Promise<void>;
        safeMintBatchByQuantity(mints: ERC721Hybrid.MintStruct[], overrides?: CallOverrides): Promise<void>;
        safeMintByQuantity(to: PromiseOrValue<string>, quantity: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        ...
        safeTransferFromBatch(tr: ERC721Hybrid.TransferRequestStruct, overrides?: CallOverrides): Promise<void>;
        setApprovalForAll(operator: PromiseOrValue<string>, approved: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
        setBaseURI(baseURI_: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        setContractURI(_contractURI: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
    ...
    populateTransaction: {
        ...
        mintBatchByQuantityThreshold(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        mintByQuantity(to: PromiseOrValue<string>, quantity: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
