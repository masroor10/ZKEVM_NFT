import { ethers, ContractFactory, utils, Contract as Contract$1, BigNumber as BigNumber$1, providers, constants as constants$1 } from 'ethers';
import globalAxios, { HttpStatusCode } from 'axios';
import { Web3Provider, JsonRpcProvider } from '@ethersproject/providers';
import $7v2Z6$metamaskdetectprovider from '@metamask/detect-provider';
...
const sendRequest = async (config, options, url, body, formData, headers, onCancel) => {
    ...
    try {
        return await globalAxios.request(requestConfig);
    }
    catch (error) {
...
class Orderbook {
    ...
    async fulfillOrder(listingId, takerAddress, takerFees) {
        ...
        if (orderResult.status !== OrderStatus$1.ACTIVE) {
    ...
    async cancelOrder(listingId, accountAddress) {
        ...
        if (orderResult.result.status !== OrderStatus$1.ACTIVE
            && orderResult.result.status !== OrderStatus$1.INACTIVE
            && orderResult.result.status !== OrderStatus$1.PENDING) {
...
class $a492ee374ae7b613$export$d902b56530cd5f87 {
    ...
    static async makeHttpRequest(url) {
        let response;
        try {
            response = await (0, globalAxios).get(url);
        } catch (error) {
...
const $1564e43dde50bb61$export$8c978679845804d4 = async (walletAddress, chainId, rename)=>{
    ...
    try {
        ...
        if (err?.code !== (HttpStatusCode).NotFound) throw new ($a8bc256d81a5e2c1$export$b722478a3cbfa3bc)(err.message || "InternalServerError | getTokensByWalletAddress", ($a8bc256d81a5e2c1$export$e3dc0620abde7f5a).GET_INDEXER_BALANCE_ERROR, err);
    }
    try {
        ...
        // means we are safe to assume that a 404 is a missing wallet due to inactivity
        // or simply an incorrect wallet address was provided.
        if (err?.code !== (HttpStatusCode).NotFound) throw new ($a8bc256d81a5e2c1$export$b722478a3cbfa3bc)(err.message || "InternalServerError | getNativeTokenByWalletAddress", ($a8bc256d81a5e2c1$export$e3dc0620abde7f5a).GET_INDEXER_BALANCE_ERROR, err);
    }
    return {
...
async function $5c763be0b0b81038$var$getMetaMaskProvider() {
    const provider = await ($a8bc256d81a5e2c1$export$bacc563de539c6c3)(async ()=>await ($7v2Z6$metamaskdetectprovider)(), {
...
async function $2e7bf45a7c9a9570$var$swapGasEstimator(config) {
    ...
    try {
        ...
        const { swap: swap } = await exchange.getUnsignedSwapTxFromAmountIn($2e7bf45a7c9a9570$var$DUMMY_WALLET_ADDRESS, inAddress, outAddress, (0, BigNumber$1).from((0, utils).parseUnits("1", $2e7bf45a7c9a9570$var$DEFAULT_TOKEN_DECIMALS)));
...
export { $d85ad1457a3f1a83$export$161d4a74df65fc08 as CHECKOUT_API_BASE_URL, $0472f23319457bfb$export$c06e1e7429de6283 as ChainId, $0472f23319457bfb$export$b874c6b1dfe85e02 as ChainName, $a8cb37a3fc8eb863$export$1f60ba4ec72508a0 as Checkout, $a8bc256d81a5e2c1$export$e3dc0620abde7f5a as CheckoutErrorType, $e055e79256bbc1dd$export$80f4da0d409a629d as ExchangeType, $de275b98d2b651c3$export$788b1fd17f3dad84 as GasEstimateType, $4b58188d47aafe8d$export$537fa3efd10ed435 as GasTokenType, $4b58188d47aafe8d$export$1fc8f52ad1810e52 as ItemType, $a47e48dd2c04791b$export$1f05a55fe0680cc7 as NetworkFilterTypes, $08d5ddc39acd6833$export$fd9b17d87f4121d2 as TokenFilterTypes, $4b58188d47aafe8d$export$65c64e46348ee3c1 as TransactionOrGasType, $4f91c5f280efe242$export$a75605c67ea83a5a as WalletFilterTypes, $e768639828688ca3$export$2d7a51a18d87e21d as WalletProviderName };
