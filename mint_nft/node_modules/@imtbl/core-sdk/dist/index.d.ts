 ...
 * @export
 */
declare type ApiOrderV3Buy = Token;
 ...
 * @export
 */
declare type ApiOrderV3MakerFees = StoreMakerTakerFee;
 ...
 * @export
 */
declare type ApiOrderV3Sell = Token;
 ...
 * @export
 */
declare type ApiOrderV3TakerFees = StoreMakerTakerFee;
 ...
 * @export
 */
declare type GetSignableOrderRequestTokenBuy = SignableToken;
 ...
 * @export
 */
declare type GetSignableOrderRequestTokenSell = SignableToken;
 ...
 * @export
 */
declare type GetSignableTradeResultFeeInfo = FeeInfo;
 ...
 * @export
 */
declare type GetSignableTradeResponseResult = GetSignableTradeResult;
...
declare const ExchangesApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createExchangeTransfer: (id: string, createTransferRequest: CreateTransferRequestV1, xImxEthAddress?: string, xImxEthSignature?: string, authorization?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
declare const ExchangesApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createExchangeTransfer(id: string, createTransferRequest: CreateTransferRequestV1, xImxEthAddress?: string, xImxEthSignature?: string, authorization?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateTransferResponseV1>>;
    /**
     * Get an exchange by ID
     * @summary Get an exchange by ID
     * @param {string} id Exchange ID
...
declare const MintsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getMint(id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Mint>>>;
    /**
     * Get details of a mintable token with the given token address and token ID
     * @summary Get details of a mintable token with the given token address and token ID
     * @param {string} tokenAddress Address of the ERC721 contract
...
declare const OrdersApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    cancelOrder: (id: string, cancelOrderRequest: CancelOrderRequest, xImxEthAddress?: string, xImxEthSignature?: string, authorization?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     * Cancel an order (V3)
     ...
     * @throws {RequiredError}
     */
    createOrder: (createOrderRequest: CreateOrderRequest, xImxEthAddress?: string, xImxEthSignature?: string, authorization?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
declare const OrdersApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    cancelOrder(id: string, cancelOrderRequest: CancelOrderRequest, xImxEthAddress?: string, xImxEthSignature?: string, authorization?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CancelOrderResponse>>;
    /**
     * Cancel an order (V3)
     * @summary Cancel an order (V3)
     * @param {string} id Order ID to cancel
     ...
     * @throws {RequiredError}
     */
    createOrder(createOrderRequest: CreateOrderRequest, xImxEthAddress?: string, xImxEthSignature?: string, authorization?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateOrderResponse>>;
    /**
     * Create an order using the v3 orderbook. Currently only buy NFT orders are supported.
     * @summary Create an order (V3)
     * @param {CreateOrderRequestV3} createOrderRequest create an order
...
declare class OrdersApi extends BaseAPI {
     ...
     * @memberof OrdersApi
     */
    cancelOrderV3(requestParameters: OrdersApiCancelOrderV3Request, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<CancelOrderResponse, any>>;
    /**
     * Create an order. Use https://docs.x.immutable.com/reference#/operations/getSignableOrder to get request body params.  This version of the endpoint is deprecated, the latest version can be found at https://docs.x.immutable.com/reference/#/operations/createOrderV3.  Deprecation date - Mon, 01 May 2023  Sunset date - Fri, 01 Sept 2023
     * @summary Create an order
     ...
     * @memberof OrdersApi
     */
    createOrderV3(requestParameters: OrdersApiCreateOrderV3Request, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<CreateOrderResponse, any>>;
    /**
     * Get an order.  This version of the endpoint is deprecated, the latest version can be found at https://docs.x.immutable.com/reference/#/operations/getOrderV3.  Deprecation date - Mon, 01 May 2023  Sunset date - Fri, 01 Sept 2023
     * @summary Get an order
     ...
     * @memberof OrdersApi
     */
    getOrderV3(requestParameters: OrdersApiGetOrderV3Request, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<OrderV3, any>>;
    /**
     * Sign cancel order message.  This version of the endpoint is deprecated, the latest version can be found at https://docs.x.immutable.com/reference/#/operations/getSignableCancelOrderV3.  Deprecation date - Mon, 01 May 2023  Sunset date - Fri, 01 Sept 2023
     * @summary Sign cancel order message
     ...
     * @memberof OrdersApi
     */
    getSignableCancelOrderV3(requestParameters: OrdersApiGetSignableCancelOrderV3Request, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<GetSignableCancelOrderResponse, any>>;
    /**
     * Generate a signable order request (V3)
     * @summary Generate a signable order request (V3)
     ...
     * @memberof OrdersApi
     */
    listOrdersV3(requestParameters?: OrdersApiListOrdersV3Request, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<ListOrdersResponseV3, any>>;
}
...
declare const TradesApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createTrade: (createTradeRequest: CreateTradeRequestV1, xImxEthAddress?: string, xImxEthSignature?: string, authorization?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    createTradeV3: (createTradeRequest: TradesCreateTradeRequest, xImxEthAddress?: string, xImxEthSignature?: string, authorization?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getTradeV3: (id: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
declare const TradesApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createTrade(createTradeRequest: CreateTradeRequestV1, xImxEthAddress?: string, xImxEthSignature?: string, authorization?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateTradeResponse>>;
    /**
     * Create a Trade. Currently only buy order is supported.
     * @summary Create a Trade (V3)
     * @param {TradesCreateTradeRequest} createTradeRequest create a trade
     ...
     * @throws {RequiredError}
     */
    createTradeV3(createTradeRequest: TradesCreateTradeRequest, xImxEthAddress?: string, xImxEthSignature?: string, authorization?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateTradeResponse>>;
    /**
     * Generate a signable trade message (V3)
     * @summary Generate a signable trade message (V3)
     * @param {GetSignableTradeRequest} getSignableTradeRequest get a signable trade
     ...
     * @throws {RequiredError}
     */
    getTradeV3(id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Trade>>;
    /**
     * Get a list of trades.  This version of the endpoint is deprecated, the latest version can be found at https://docs.x.immutable.com/reference/#/operations/listTradesV3.  Deprecation date - Mon, 01 May 2023  Sunset date - Fri, 01 Sept 2023
     * @summary Get a list of trades
     * @param {string} [partyATokenType] Party A\&#39;s (buy order) token type of currency used to buy
...
declare class TradesApi extends BaseAPI {
     ...
     * @memberof TradesApi
     */
    createTradeV3(requestParameters: TradesApiCreateTradeV3Request, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<CreateTradeResponse, any>>;
    /**
     * Generate a signable trade message (V3)
     * @summary Generate a signable trade message (V3)
     ...
     * @memberof TradesApi
     */
    getTradeV3(requestParameters: TradesApiGetTradeV3Request, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<Trade, any>>;
    /**
     * Get a list of trades.  This version of the endpoint is deprecated, the latest version can be found at https://docs.x.immutable.com/reference/#/operations/listTradesV3.  Deprecation date - Mon, 01 May 2023  Sunset date - Fri, 01 Sept 2023
     * @summary Get a list of trades
     ...
     * @memberof TradesApi
     */
    listTradesV3(requestParameters?: TradesApiListTradesV3Request, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<ListTradesResponse, any>>;
}
...
declare const TransfersApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createTransfer: (createTransferRequestV2: CreateTransferRequest, xImxEthAddress?: string, xImxEthSignature?: string, authorization?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    createTransferV1: (createTransferRequest: CreateTransferRequestV1, xImxEthAddress?: string, xImxEthSignature?: string, authorization?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
declare const TransfersApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createTransfer(createTransferRequestV2: CreateTransferRequest, xImxEthAddress?: string, xImxEthSignature?: string, authorization?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateTransferResponse>>;
    /**
     * Create a new transfer request. Use https://docs.x.immutable.com/reference#/operations/getSignableTransferV1 to get request body params.
     * @summary Creates a transfer of tokens between two parties
     * @param {CreateTransferRequestV1} createTransferRequest Create transfer
     ...
     * @throws {RequiredError}
     */
    createTransferV1(createTransferRequest: CreateTransferRequestV1, xImxEthAddress?: string, xImxEthSignature?: string, authorization?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateTransferResponseV1>>;
    /**
     * Gets bulk details of a signable transfer
     * @summary Gets bulk details of a signable transfer
     * @param {GetSignableTransferRequest} getSignableTransferRequestV2 get details of signable transfer
...
declare const UsersApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    registerPassportUser: (authorization: string, registerPassportUserRequest: ApiRegisterPassportUserRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     * Registers a user
...
declare const UsersApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    registerPassportUser(authorization: string, registerPassportUserRequest: ApiRegisterPassportUserRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Registers a user
     * @summary Registers a user
     * @param {RegisterUserRequest} registerUserRequest Register User
...
declare class UsersApi extends BaseAPI {
     ...
     * @memberof UsersApi
     */
    registerPassportUser(requestParameters: UsersApiRegisterPassportUserRequest, options?: AxiosRequestConfig): Promise<axios.AxiosResponse<object, any>>;
    /**
     * Registers a user
     * @summary Registers a user
...
declare const Config: {
    ...
    createConfig: ({ coreContractAddress, registrationContractAddress, chainID, basePath, headers, sdkVersion, }: Environment) => ImmutableXConfiguration;
};
